...
<div class="homelinks-container" style="margin-left:30px; margin-top:100px;">
  ...
  <div class="row_adm00">  
	...
	<?php } ?>
        ...
        <a onclick="view_latest_jobApplications()" style="cursor:pointer;"> <li><img src="<?php echo base_url().'assets/images/businessman65.png'; ?>"><br /><label>Jobs Appliers
