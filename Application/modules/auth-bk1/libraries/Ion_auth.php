		...
		if ( $this->ion_auth_model->forgotten_password($identity) )   //changed
		{
			...
			if ($user)
			{
				...
				//	$message = $this->load->view($this->config->item('email_templates', 'ion_auth').$this->config->item('email_forgot_password', 'ion_auth'), $data, true); 
					 $message  = '<a href="'.base_url().'reset_password/'. $user->forgotten_password_code.'">Reset password</a><br/><br/>Thank you !<br/><br/><br/><strong>regards</strong><br/><a href="http://bgjobfinder.com">bgjobfinder.com</a>';
	...
	public function register($username, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
		...
		else
		{
			...
			//	$message = $this->load->view($this->config->item('email_templates', 'ion_auth').$this->config->item('email_activate', 'ion_auth'), $data, true);
				//$message  = ' Thank you for registering at <a href="http://hiremeee.com" target="_blank">www.hiremeee.com</a>. Please click the following link to activate your account ! <br/><br/>' ;
				//$message .= '<a href="'.base_url().'auth/activate/'. $user->id .'/'.$activation_code.'">Activate my account</a><br/>';		
				
				$data['activation_code'] = $activation_code;
				$data['username'] =  $user->username ; 
				$message 		  = $this->load->view('auth/email/activation-email', $data, true);
