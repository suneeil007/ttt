...
//over_view
	    // $pro_data['p_activity']   		 = $this->input->post('p_activity' , true);		
		// $pro_data['Group_size']          = $this->input->post('group_size', true);		
        //$pro_data['country']             = $this->input->post('country', true);	
        //$pro_data['arrrival_on']         = $this->input->post('arrival_on', true);	
       // $pro_data['meals']               = $this->input->post('meals', true);	
       // $pro_data['accomodation']   	 = $this->input->post('accomodation' , true);		
		//$pro_data['trip_code']           = $this->input->post('trip_code', true);		
       // $pro_data['s_activity']          = $this->input->post('s_activity', true);	
       // $pro_data['max_altitude']        = $this->input->post('max_altitude', true);	
       // $pro_data['transportation']      = $this->input->post('transportation', true); 
        //$pro_data['departure_from']      = $this->input->post('departure_from' , true); 
