...
//				$this->template->load('admin/admin','admin/add_edit', $this->data);
			$this->template->load('admin/admin', 'auth/index', $data) ;
		}
	}
...
//			$this->_render_page('auth/change_password', $data);
			$this->template->load('admin/admin', 'auth/change_password', $data) ;
		}
		else
		{
...
//			$this->_render_page('auth/forgot_password', $data);
			$this->template->load('admin/admin', 'auth/forgot_password', $data) ;
		}
		else
		{
...
//				$this->_render_page('auth/reset_password', $data);
			$this->template->load('admin/admin', 'auth/reset_password', $data) ;
			}
			else
			{
...
//			redirect("auth/forgot_password", 'refresh'); 
	...
	function deactivate($id = NULL)
	{
		...
		$this->template->load('admin/admin', 'auth/deactivate_user', $data) ;
		}
		else
		{
	...
	function create_user()
	{
		...
		//	$this->_render_page('auth/create_user', $data);
				$this->template->load('admin/admin', 'auth/create_user', $data) ;
		}
	}
...
//		$this->_render_page('auth/edit_user', $data); 
			$this->template->load('admin/admin', 'auth/edit_user', $data) ;
	}
...
//			$this->_render_page('auth/create_group', $data);
			$this->template->load('admin/admin', 'auth/create_group', $data) ;
...
//		$this->_render_page('auth/edit_group', $data);
			$this->template->load('admin/admin', 'auth/edit_group', $data) ;
