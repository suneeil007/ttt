...
<?php if(isset($products) && count($products)>0){ $i = 0 ; ?>
    ...
    <li style="margin-bottom:25px;">
		...
		<p class="time1"><a href="<?php echo base_url().'cms/product/'.$product->id ;?>" style="height:45px; width:155px;  display:block; float:right; line-height:44px;"><button type="button" class="btn btn-info">View Details</button></a></p>
