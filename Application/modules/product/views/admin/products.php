...
<h1>Add Issue</h1><br/>
	...
	<option value="<?php echo $category->id ; ?>" <?php if($this->uri->segment(4) == $category->id) echo ' selected';?>><?php echo $category->name ; ?></option>						
            ...
            <div class="element-block">
            	<div class="title_lbl"><strong> Issue Sub Category</strong></div>	
                    <select name="sub_category" id="sub_category" onchange="changeSub(<?php echo $this->uri->segment(4); ?>, this.value);">						
                        <option value="-1">-- none --</option>												
                    </select>
              </div><br/><br/>
			<div class="element-block">
				<div class="title_lbl"><strong>Issue Title</strong></div>
            ...
            <div class="element-block" style="display: none;">
				<div class="title_lbl"><strong>Duration</strong></div>
...
<div  class="element-block" style="width:990px; display: none; height:20px; margin-top:5px; ">
...
<td><input type="text" name="p_activity" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->p_activity ; ?>"/></td>
<td>
<i class="fa fa-hand-o-right"></i>
<span class="desctiption-title"> Secondary activity:</span>
</td>
<td><input type="text" name="s_activity" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->s_activity ; ?>"/></td>
</tr>
<tr>
<td>
...
<td><input type="text" name="group_size" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->Group_size ; ?>"/> </td>
<td>
<i class="fa fa-check-circle-o"></i>
<span class="desctiption-title"> Max-Altitude:</span>
</td>
<td> <input type="text" name="max_altitude" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->max_altitude ; ?>"/> </td>
</tr>
<tr>
<td>
...
<td><input type="text" name="country" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->country ; ?>"/></td>
<td>
<i class="fa fa-road"></i>
<span class="desctiption-title"> Transportation:</span>
</td>
<td><input type="text" name="transportation" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->transportation ; ?>"/></td>
</tr>
<tr>
<td>
...
<td><input type="text" name="arrival_on" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->arrrival_on ; ?>"/></td>
<td>
<i class="fa fa-plane"></i>
<span class="desctiption-title"> Departure from:</span>
</td>
<td><input type="text" name="departure_from" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->departure_from ; ?>"/></td>
</tr>
...
<td width="30%"><input type="text" name="meals" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->meals ; ?>"/></td>

<td width="20%">
<i class="fa fa-barcode"></i>
<span class="desctiption-title"> Trip Code:</span>
</td>
<td width="30%"><input type="text" name="trip_code" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->trip_code ; ?>"/></td>
...
<td colspan="3"><input type="text" name="accomodation" value="<?php if(isset($product_row) && count($product_row)>0) echo $product_row->accomodation ; ?>"/></td>
</tr>
</tbody>
</table>
...
<div class="element-block">
				<div class="title_lbl"><strong>Summary</strong></div>
         ...
         <div class="CB" style="height:30px;"></div>
           ...
           <div class="element-block" style="margin-top:-10px;">
				<div class="title_lbl"><strong>Contents</strong></div>
   ...
   <div class="CB" style="height:30px;"></div>
           ...
           <div class="element-block" style="display: none;">
				<div class="title_lbl"><strong>Service Includes</strong></div>
	...
	<table class="display" id="datatables">
            <thead>
              <tr>
                ...
                <th class="alignleft">Issue Title</th>
                <th class="alignleft" style="display: none;">Time span</th>

                <th class="alignleft" style="display: none;">Price</th>				
                <th class="alignleft" >Image</th>	
															
                <th class="alignleft" style="display: none;" >Hide Price ?</th>																					
            ...
            <tbody id="addCategory">			
			 <?php if(!empty($products)) : ?><?php $counter = 0;?>
              ...
              <tr class="row<?=$product->id?>" <?php if($counter%2 == 0)echo ' id="tble-row-even"' ; else echo ' id="tble-row-odd"' ;?>><?php $counter++ ;?>
				...
				<td style="text-align:left;font-size:13px; display: none;"><?php echo $product->model;?></td>
				<td style="text-align:left;font-size:13px;  display: none;"><?php echo $product->currency.' '.$product->price;?></td>
			...
			<img src="<?php echo base_url().PRODUCTS_DIR.'/'.$product->image; ?>" height="60" width="100" class="cat_pic"/>
				...
				<td style="text-align:left;font-size:13px;  display: none;"><a href="#" onclick='price_status(<?php echo $product->id ;?>)'><?php echo $product->hide_price;?></a></td> 				 
