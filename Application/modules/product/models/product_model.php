...
$table = $this->get_table();
  ...
  function delete_product_variety($id) {	
	...
	function get_popular_products(){
		...
		$query  =	$this->general_db_model->_custom_query('SELECT * FROM products ORDER BY RAND() DESC LIMIT 6');
  ...
  function getProductByParentId($id){
          ...
          $query  =	$this->general_db_model->_custom_query('SELECT * FROM products WHERE cat_id =' .$id);
